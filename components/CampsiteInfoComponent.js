                ...
                <Card 
                    ...
                    <View style={styles.cardRow}>
                        <Icon
                            ...
                            raised
                            reverse
                            onPress={() => props.favorite ? console.log('Already se as a favorite') : props.markFavorite()}
                        />
                        <Icon
                            name='pencil'
                            type='font-awesome'
    ...
    const renderCommentItem = ({item}) =>{
        return(
            <View style ={{margin: 10}}>
                ...
                <Rating readOnly startingValue={item.rating} style ={{fontSize:12, alignItems: 'flex-start', paddingVertical: '5%'}} imageSize={10}> Stars</Rating>
